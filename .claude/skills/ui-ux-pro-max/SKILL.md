...
The search script lives at `.claude/skills/ui-ux-pro-max/scripts/search.py`, relative to the repository root (`terminalfor`). Always invoke it with that path — do not assume a different working directory:
